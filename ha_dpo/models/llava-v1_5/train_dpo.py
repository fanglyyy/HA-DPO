...
class LazySupervisedDataset(Dataset):
    ...
    def __init__(self, 
        ...
        list_data_dict = pope_data_dict[10]
...
def main():
    ...
    # with open("ha_dpo/models/llava-v1_5/config.json", "r")as f: # 读取数据集和模型配置文件
    #     cont = json.load(f)
    #     model_args.model_name_or_path = cont["model_path"]
    #     data_args.my_data_path = cont["data_path"]
